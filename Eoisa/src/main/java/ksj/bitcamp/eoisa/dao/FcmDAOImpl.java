...
public class FcmDAOImpl implements FcmDAO {
	...
	public void push() {
		try {
			...
			if (after > current) {
				...
				ResponseEntity<String> res = rt.exchange(BASE_URL + FCM_SEND_ENDPOINT, HttpMethod.POST, httpEntity,
						String.class);
	...
	private String getAccessToken() throws IOException {
		GoogleCredential googleCredential = GoogleCredential
				.fromStream(new FileInputStream("/var/eoisa/project-eoisa.json")).createScoped(Arrays.asList(SCOPES));
